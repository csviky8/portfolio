...
export default function Contact() {
  ...
  const inputClass = "w-full px-4 py-3 rounded-xl text-sm outline-none border-2 transition-all duration-200 focus:border-[var(--brand)] focus:shadow-[0_0_0_4px_rgba(37,99,235,0.08)]"
  const inputStyle = { background: 'var(--bg2)', borderColor: 'var(--border)', color: 'var(--text)' }

  return (
    <section id="contact" ref={ref} className="py-24" style={{ background: 'var(--bg2)' }}>
          ...
          <div className="section-reveal space-y-4">
            {contactLinks.map((c) => (
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-2xl border card-hover group"
              ...
              >
                ...
                <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity" style={{ color: c.color }}>
          ...
          <div className="section-reveal">
            ...
            >
              ...
              <button
                ...
                className="btn-shimmer w-full py-3 rounded-xl font-semibold text-sm disabled:opacity-60"
