  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled ? 'py-3 bg-[#050d0a]/90 backdrop-blur-md border-b border-[rgba(22,181,112,0.1)]' : 'py-5'
      }`}
    >
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        <a
          ...
          className="hidden md:inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium border transition-all duration-200 hover:bg-[rgba(22,181,112,0.1)]"
        ...
        >
          ...
          <span
            className="block h-0.5 w-6 transition-all duration-200"
            style={{ background: 'var(--brand)', opacity: open ? 0 : 1 }}
          />
          <span
            className="block h-0.5 w-6 transition-all duration-200"
            style={{
